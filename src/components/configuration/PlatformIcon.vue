<template>
  <span class="platform-icon" :class="`platform-icon--${platformName}`">
    <!-- WordPress -->
    <svg v-if="platformId === 1" width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
    ...
    <!-- Instagram -->
    <svg v-else-if="platformId === 2" width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
